...
CREATE TABLE `usuarios` (
  ...
  `nome` varchar(45) CHARACTER SET latin1 NOT NULL COMMENT 'Nome do Usuário',
  `senha` varchar(20) CHARACTER SET latin1 NOT NULL COMMENT 'Senha cripotografada com hash',
...
INSERT INTO `usuarios` VALUES (1,'admin','admin','gerente'),(2,'financeiro','financeiro','financeiro'),(3,'almoxarifado','almoxarifado','almoxarifado'),(4,'compras','compras','compras');
